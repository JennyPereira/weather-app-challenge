...
const locationQuery = async (lat, long) => {
    let urlLocation = `https://cors.bridged.cc/<https://www.metaweather.com/api/location/search/?lattlong=${lat},${long}>`;
    ...
    return `https://cors.bridged.cc/<https://www.metaweather.com/api/location/${woeid}>`;
}
...
const searchLocation = async () =>{
    ...
    if (city!=="") {
        let urlCity = `https://cors.bridged.cc/<https://www.metaweather.com/api/location/search/?query=${city}>`;
